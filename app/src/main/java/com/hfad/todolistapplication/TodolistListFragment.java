...
public class TodolistListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView ItemRecycler = (RecyclerView)inflater.inflate(R.layout.fragment_todolist_list, container, false);
        ListAdapter adapter = new ListAdapter(itemNames, statusNames);
